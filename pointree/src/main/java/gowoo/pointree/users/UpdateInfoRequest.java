...
public class UpdateInfoRequest {
    ...
    public UpdateInfoRequest(String email, String password, String name, String phoneNumber, int accumulationRate) {
        this.email = email;
    ...
    private void validate() {
        ...
        if (accumulationRate < 0 || accumulationRate > 100) throw new BadRequestException("0~100까지만 입력 가능합니다.");
    }
}
